...
class Dataset:
    ...
    def trainLoader(self):
        ...
        #train_file_names = sorted(glob.glob(os.path.join('/home/lzz/sde1/otoc/multitask_moco_final_loss_cuda_more_iter/train_cuda_0807/*' + self.filename_suffix)))
    ...
    def valLoader(self):
        val_file_names = sorted(glob.glob(os.path.join(self.data_root, self.dataset,  'scene000' + self.filename_suffix)))
    ...
    def testLoader(self, path):
        ...
        #self.test_file_names=sorted(glob.glob(os.path.join('/media/lzz/faef702d-ca59-4dad-a70a-089cc782183e1/pg/scannetv2/test/*' + self.filename_suffix)))
        ...
        self.test_files=[]
        print ('aaaaaaaaaaaaaaaaaaaaaaaaaa',os.path.join(path+'/*' + self.filename_suffix))
